    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 24) {
                        ...
                        if isGenerated {
                            HStack(spacing: 0) { // spacing 0 to let Spacer do full separation
                                Button(action: {
                                    isImageVisible = true
                                }) {
                                    HStack {
                                    ...
                                    .padding(.vertical, 16)
                                    .padding(.horizontal, 24) // Natural padding
        ...
        .sheet(isPresented: $isImageVisible) {
            ZStack {
                ...
                VStack(spacing: 24) {
                    // Manual Capsule Removed - using drag indicator
